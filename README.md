# SCP-CS-BRKGA
Implementação desenvolvida como parte do TCC da Graduação em Ciência da Computação. O texto integral está disponível neste repositório com o nome 'TCC_Andre_Arce'. 

O trabalho consiste em um algoritmo BRKGA implementado em C++ para resolver instâncias do Set Covering Problem with Conflicts on Subsets. O projeto consiste em 3 principais arquivos:
...
Após definir os parâmetros no arquivo 'brkga.cpp', para gerar o .exe do projeto basta executar no terminal o seguinte comando:
